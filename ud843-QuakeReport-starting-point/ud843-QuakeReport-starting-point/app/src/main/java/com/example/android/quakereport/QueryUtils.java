    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                String magnitude = p.getString("mag");
                ...
                String mag = formatter.format(Float.parseFloat(magnitude));

                if(place.contains("of")){

                    int placeIndex = place.indexOf("of");
                    location = place.substring(0, placeIndex+2);
                    city = place.substring(placeIndex+2);
                ...
                earthquakes.add(new Earthquake(mag, location, city, dateToDisplay, timeToDisplay));
            }
